                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="mil-card">
                            ...
                            <div class="mil-description">
                                ...
                                <div class="mil-card-text">
                                    <p>At AIC Tech Solution, we configured a secure site-to-site VPN between Microsoft
                                        Azure and SonicWall Firewall, enabling encrypted communication between
                                        on-premises infrastructure and Azure cloud resources. This setup ensures
                                        continuous connectivity, strong encryption, and automated failover for high
                                        availability, allowing businesses to securely access cloud applications and
                                        internal servers.</p>
                                </div>
                            </div>
                        </a>
                    ...
                    <div class="swiper-slide">
                        <a href="#" class="mil-card">
                            ...
                            <div class="mil-description">
                                <div class="mil-card-title">
                                    <h4 class="mil-mb-20">Successful Migration from Windows Server 2008 R2 to Azure
                                        Server 2022</h4>
                                    {{-- <h6>by: <span class="mil-accent">Nguta Ithya</span></h6> --}}
                                </div>
                                <div class="mil-card-text">
                                    <p>We successfully migrated an on-premises Windows Server 2008 R2 to Azure Server
                                        2022, ensuring improved performance, security, and scalability. The migration
                                        included data, Active Directory, and applications, all transitioned seamlessly
    ...
    <section class="mil-skills mil-p-120-90">
        <div class="container">
            <div class="row align-items-end mil-mb-90">
                ...
                <div class="col-xl-6">
                    <h3> <span class="mil-accent">Are delays from your local IT support costing you valuable time?</span></h3>
                    <p class="mil-mt-60-adapt">Managing technology can be overwhelming constant updates, system errors,
                        and security threats make it hard to focus on growth. For small and mid-sized businesses without
                        a dedicated IT team, every delay costs time and productivity.<br><br>Worried about data security
                        or how to align IT with your business goals?<br><br>At AIC Tech Solution, we simplify IT
                        management with reliable support, strong security, and modern cloud solutions — helping you save
                        time, stay secure, and focus on success.</p>
                </div>
            </div>
