...
<div class="mil-top-position mil-fixed">
    ...
    ">
        ...
        <div class="container">
            <a href="/" class="mil-logo" style="width: 250px; height: 150px;"></a>
            <div class="mil-navigation">
                <nav>
                    <ul>
                        ...
                        {{-- <li class="mil-has-children"> --}}
                            {{-- <a href="#.">Services</a> --}}
                        <li class="mil-has-children"><a href="{{route('services')}}">Service</a>
                        <ul>
                            {{-- <li><a href="services">Service 1</a></li> --}}
                            <li><a href="/it-infrastructure">IT Infrastructure & Cloud Services</a></li>
                            <li><a href="/it-solution">All-in-One IT Solutions</a></li>
                            <li><a href="/bpo-services">IT Solutions BPO Services</a></li>
                            {{-- <li><a href="service-4.html">Protecting Your Digital World</a></li>
                            <li><a href="service-4.html">Empowering Your Team from Anywhere</a></li>
                            <li><a href="service-4.html">BPO Services</a></li> --}}
                        </ul>
                    </li>
                        {{-- </li> --}}
                        {{-- <li class="mil-has-children"> --}}
